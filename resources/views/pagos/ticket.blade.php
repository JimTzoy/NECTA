...
<div class="container">
    <!-- Invoice Wrapper Start -->
      <div class="card">
        ...
        <hr>
        <div class="row">
          <div class="col-xs-6 col-sm-6 col-md-6" style="border-right: 1px solid #9e9c9c;">
            <p>Recibi de:</p>
            <p class="text2">{{$cte->Nombre}} {{$cte->ApPaterno}} {{$cte->ApMaterno}}</p>
          </div>
          <div class="col-xs-3 col-sm-3 col-md-3" style="border-right: 1px solid #9e9c9c;">
            <p>Cantidad</p>
        ...
        <div class="row">
          <div class="col-xs-6" style="border-right: 1px solid #9e9c9c;">
            <p>Fecha Inicio</p>
            <p class="text2">@foreach ($va as $item)
